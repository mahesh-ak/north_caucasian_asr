...
torchrun --nproc_per_node=2 src/train.py --model-dir Qwen/Qwen2-Audio-7B-Instruct --data-dir tokenized_data/Archi/Qwen2-Audio-7B-Instruct/split --num-epochs 5 --batch-size 2 #--full-shard
torchrun --nproc_per_node=2 src/train.py --model-dir Qwen/Qwen2-Audio-7B-Instruct --data-dir tokenized_data/Rutul/Qwen2-Audio-7B-Instruct/split1 --num-epochs 5 --batch-size 2 #--full-shard
