...
torchrun --nproc_per_node=2 src/train.py --model-dir Qwen/Qwen2-Audio-7B-Instruct --data-dir tokenized_data/Archi/Qwen2-Audio-7B-Instruct/split --num-epochs 0 --batch-size 1 --full-shard
