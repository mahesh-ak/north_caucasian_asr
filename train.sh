...
torchrun --nproc_per_node=2 src/train.py --model-dir neurlang/ipa-whisper-small --data-dir tokenized_data/Rutul/ipa-whisper-small/split1 --results-dir results/Rutul/ipa-whisper-small/zero_shot --num-epochs 0 --batch-size 1
torchrun --nproc_per_node=2 src/train.py --model-dir neurlang/ipa-whisper-small --data-dir tokenized_data/Archi/ipa-whisper-small/split --results-dir results/Archi/ipa-whisper-small/zero_shot --num-epochs 0 --batch-size 1
torchrun --nproc_per_node=2 src/train.py --model-dir neurlang/ipa-whisper-small --data-dir tokenized_data/Rutul/ipa-whisper-small/split1 --num-epochs 20 --batch-size 1
torchrun --nproc_per_node=2 src/train.py --model-dir neurlang/ipa-whisper-small --data-dir tokenized_data/Rutul/ipa-whisper-small/split --num-epochs 20 --batch-size 1
