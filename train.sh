...
#torchrun --nproc_per_node=1 src/train.py --model-dir openai/whisper-large-v3 --data-dir tokenized_data/Rutul/whisper-large-v3/split1 --num-epochs 10 --batch-size 2
#torchrun --nproc_per_node=1 src/train.py --model-dir openai/whisper-large-v3 --data-dir tokenized_data/Archi/whisper-large-v3/split --num-epochs 10 --batch-size 2
